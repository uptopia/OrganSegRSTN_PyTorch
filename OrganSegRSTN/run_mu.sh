...
# DATA_PATH='/mnt/data0/tianwei/NIH/'
DATA_PATH='/home/iclab/work/mu/'
...
then
	python3 coarse2fine_testing.py \
		$DATA_PATH $CURRENT_FOLD $ORGAN_NUMBER $LOW_RANGE $HIGH_RANGE \
