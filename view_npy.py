...
p2 = 'up/results/coarse_testing_1e-5x10,20/FD0:XJ3_1_20180822_204202.pkl/volumes/e2682_1/volume.npy'
p3 = 'mu/images/0001.npy'
p4 = 'mu/results/coarse_testing_1e-5x10,20/FD0:XJ3_1_20180822_204202.pkl/volumes/e2682_1/volume.npy'
...
if case ==1:
  ...
  data_output = np.load(dir+p4)
else:
  data_input = np.load(dir+p1)
  data_output = np.load(dir+p2)

fig = plt.figure(figsize=(10, 7)) 
# fig.add_subplot(rows=1, columns=2, index=1) 
for i in range(30,data_input.shape[2]):
  # plt.imshow(data[:, :, i].astype(np.float32), cmap='gray')
  # plt.title('slice # ' + str(i))
  # plt.show(block=False)
  # plt.pause(0.1)
